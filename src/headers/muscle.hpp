...
class Muscle : public Spring
{
    ...
    public:
        ...
        Muscle(Particle& p1, Particle& p2, int env_id, int idx, float len, float spring_const, bool outside_body, float contraction_limit=0.4, float max_spring_constant_scaling=20);
